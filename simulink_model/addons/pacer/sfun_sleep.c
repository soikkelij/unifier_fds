/* sfun_sleep.c - a simple s-function to pause Simulink executation a
 * certain number of milliseconds at each Simulink MajorTimeStep.
 *
...
#define S_FUNCTION_NAME  sfun_sleep
#define S_FUNCTION_LEVEL 2

#include "simstruc.h"

#define SAMPLE_TIME(S)  ssGetSFcnParam(S,0)
...
static void mdlInitializeSampleTimes(SimStruct *S)
{
    ...
    ssSetSampleTime(S, 0, mxGetScalar(SAMPLE_TIME(S)) );
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    if (ssIsMajorTimeStep(S)){
        SLEEP( u[0] ); // user-defined SLEEP() function above
    }
}
